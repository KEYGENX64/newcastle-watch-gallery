...
@Component({
    selector: 'widget-input-password',
    templateUrl: './input-password.widget.html',
    styleUrl: './input-password.widget.scss',
    standalone: true,
    imports: [CommonModule, MatInputModule, MatFormFieldModule, MatIconModule,
        ReactiveFormsModule, MatButtonModule, TranslocoModule]
})
export class InputPasswordWidget extends BaseComponent {
