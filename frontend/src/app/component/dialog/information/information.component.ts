...
import { DialogInformation } from "./information.type";
...
export class DialogInformationComponent extends BaseComponent {
    currentDirection: 'ltr' | 'rtl' = 'ltr';
    constructor(@Inject(DIALOG_DATA) public data: DialogInformation, private _appSetting: AppSettingService) {
        super();
    }
    ngOnInit() {
